...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9898555.876765, 1663395.014805, -9706261.064366, 1800196.275777], maxZoom: 28, minZoom: 1
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Aldeas_Afectadas_Cortes_4,
      colName: 'nombre',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-9898555.876765, 1663395.014805, -9706261.064366, 1800196.275777], map.getSize());
